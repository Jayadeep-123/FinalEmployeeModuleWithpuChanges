...
public interface EmpSalaryInfoRepository extends JpaRepository<EmpSalaryInfo, Integer> {
    ...
    // Find decrypted salary info by temp_payroll_id
    @Query(value = "SELECT esi.emp_sal_info_id, esi.emp_id, esi.payroll_id, esi.emp_payment_type_id, " +
                   ...
                   "WHERE esi.temp_payroll_id = :tempPayrollId AND esi.is_active = 1", nativeQuery = true)
