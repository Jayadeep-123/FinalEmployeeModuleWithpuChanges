...
public interface EmployeeRepository extends JpaRepository<Employee, Integer>, EmployeeRepositoryCustom {
        ...
        @Query(value = "SELECT emp_stud_application_role FROM sce_admin.sce_emp_view WHERE emp_id = :empId LIMIT 1", nativeQuery = true)
        String findApplicationRoleByEmpId(@Param("empId") Integer empId);
